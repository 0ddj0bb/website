...
/* Function for pulling the profile image. */
function twprofileimg(tag_id, widget_id){
    twitterFetcher.fetch(widget_id,'twitter',1,true,true,true,'',false,function(tweets){
        link = $(tweets[0]).find('img').attr('src').replace('_normal', '_bigger');
        console.log(link);
